({
    ...
    getValidators : function(component,recordId) {
        debugger;
        var action = component.get("c.getValidators");
    ...
    submitToValidator : function(component,helper,resp){
        debugger;
        var action = component.get("c.submitToValidator");
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                if(respData.errorFlag == false){
                    helper.showToast('Success','Record submitted to Validator.');

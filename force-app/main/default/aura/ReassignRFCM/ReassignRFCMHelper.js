({
    ...
    getReassignList : function(component,recordId) {
        debugger;
        var action = component.get("c.getReassignList");
    ...
    reassign : function(component,helper,resp){
        debugger;
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                if(respData.errorFlag == false){
                    helper.showToast('Success','Reassigned to New User.');

({
    init : function(component, event, helper) {
        component.set('v.mycolumns', [
            {label: 'Collection Date', fieldName: 'due_date__c', type: 'date'},
            {label: 'UNILAB, Inc.', fieldName: 'ui__c', type: 'number'},
            {label: 'RiteMed', fieldName: 'rt__c', type: 'number'},
            {label: 'ULSSI', fieldName: 'ulssi__c', type: 'number'},
            {label: 'Pharex', fieldName: 'phx__c', type: 'number'}
        ]);

({
    init : function(component, event, helper) {
        component.set('v.mycolumns', [
            {label: 'Implementation Date', fieldName: 'impl_date__c', type: 'date'},
            {label: 'SKU', fieldName: 'sku__c', type: 'text'},
            {label: 'Old Price', fieldName: 'old_price__c', type: 'number'},
            {label: 'New Price', fieldName: 'new_price__c', type: 'number'}
        ]);

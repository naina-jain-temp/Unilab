({
    ...
    getProjectOwners : function(component,recordId) {
        debugger;
        var action = component.get("c.getProjectOwners");
    ...
    submitToProjectOwner : function(component,helper,resp){
        debugger;
        var action = component.get("c.submitToProjectOwner");
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                if(respData.errorFlag == false){
                    helper.showToast('Success','Record submitted to Project Owner.');

...
const columns = [
    { label: 'Title',       fieldName: 'Title', initialWidth: 350,
        cellAttributes: { 
            iconName: { fieldName: 'icon' }, iconPosition: 'left' , 
        }
    },/*
    { label: 'Description',  fieldName: 'Des', wrapText : true,
        cellAttributes: { 
...
export default class ContentManager extends NavigationMixin(LightningElement) {
    ...
    handleSync(){
        ...
        .then(result => {
            ...
            finalData.forEach(file => {
                ...
                file.Des  = file.ContentDocument.Description;
    ...
    handleSearch(event){
        ...
        //let fileDesc = file => {file.Des.toLowerCase().includes(value.toLowerCase())};
        if( name === 'Title' ){
